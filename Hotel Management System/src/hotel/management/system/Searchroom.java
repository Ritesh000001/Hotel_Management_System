   ...
   Searchroom()
    {
       ...
       available.setBounds(200,120,180,30);
       available.setBackground(Color.WHITE);
       add(available);
       
       search = new JButton("Search");
       search.setBounds(500,125,120,25);
   ...
   public void actionPerformed(ActionEvent ae)
   {
       if(ae.getSource()==search)
       {
           ...
           try
           {
            ...
            String query2 = "Select * from rooms where bed_type='"+bedtype.getSelectedItem()+"' AND room_type ='"+roomtype+"' AND availability= 'Available'" ;
